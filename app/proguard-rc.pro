# ZCODE v1.0.20-rc1 — R8 konservatif tetapi nyata.
#
...
# Boundary Java/JNI Chaquopy dijaga luas pada RC1. Dipersempit hanya setelah
...
# tetapi safety keep kecil ini menjaga lifecycle RC1 saat R8 baru diadopsi.
