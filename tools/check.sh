...
pytest test_zcode_fase0.py test_zcode_fase1.py test_zcode_fase3.py test_zcode_package_runtime.py test_zcode_kotlin_guards.py test_zcode_security_guards.py test_native_runtime_rebirth_guards.py test_zcode_production_release.py test_zcode_license_guards.py test_v1021_commit_and_save_guards.py -v
